...
def filter_and_save_direct(
    ...
    COPY (
        SELECT 
            ...
            CAST(subject->>'did_id' AS BIGINT) as subject_did_id,
            subject->>'collection' as subject_collection
...
def main():
    """Example usage"""
    # Input file path
    input_file = "list_blocks.parquet"  # Update this path
    ...
    data_batch = filter_and_save_direct(
        ...
        output_file='list_blocksFiltered.parquet',
    )
