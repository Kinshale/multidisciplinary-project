...
def filter_and_save_direct(
    ...
    COPY (
        SELECT 
            ...
            CAST(subject_id AS BIGINT) as subject_did_id,
            CAST(list->>'did_id' AS BIGINT) as list_did_id,
            list->>'collection' as list_collection,
...
def main():
    ...
    # Input file path
    input_file = "list_items.parquet"  # Update this path
    output_file = "list_itemsFiltered.parquet"
